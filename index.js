...
function no_button(){
    ...
    if (clickCounter == 1) {
        ...
        para.id = 'para'; 
        let text_1 = document.createTextNode('Em vừa bấm chọn cái gì vậy??? Chọn lại cho anh ik');
        ...
        para_1.id = 'para';
        let text_2 = document.createTextNode('Đừng đùa anh nữa em ơi!!!');
        ...
        para_2.id = 'para';
        let text_3 = document.createTextNode('Chán em ghê vẫn cứ chọn sai thôi:)');
        ...
        para_3.id = 'para';
        let text_4 = document.createTextNode('Anh buồn quá')
...
function yes_button(){
    ...
    var new_text = 'Lựa chọn đúng rồi đấy hehe';

    var new_text_1 ='Anh mong là món quà nhỏ này sẽ khiến em cảm thấy hạnh phúc. Anh yêu em';
    document.getElementById('final_text').innerText = new_text;
    document.getElementById('text_2').innerText = new_text_1;
    picture.src ='final.jpg';
